...
import com.HCIHonors.javastroid.gameobjects.GameObject;
...
///////////////////////////////////////////Member Variables//////////////////////////////////////////////////////////////////
	 ...
	 Controller control;  //controller object from Controller class
...
//////////////////////////////////////////////////Member Methods////////////////////////////////////////////////////////////////
	...
	/*
	public void gameMode(int mode2) {
	...
	public void render(int mode){
			Gdx.app.log("Renderer.java:", "In render");

			switch(mode){
			
			//If click the first option it accesses the positive comments
			case 1:
				//gameMode(mode);
				//shot = false;
				spriteBatch.begin(); //calls sprit batch to begin/start
				 ...
				 font.draw(spriteBatch, "HCI JavaStroid Game", 50, (Gdx.graphics.getHeight()- 40)); //draw font set text and location
		...
		//negative commetns
			case 3:
				...
				spriteBatch.begin(); //calls sprit batch to begin/start
				 ...
				 font.setColor(Color.YELLOW); //set font color to yellow
				 font.draw(spriteBatch, "HCI", 50, (Gdx.graphics.getHeight()- 40)); //draw font set text and location
				 font.setColor(Color.GREEN);//set font color to green
				 font.draw(spriteBatch, "Press Space to Shoot and Up to move.", 50, (Gdx.graphics.getHeight()- 70));//draw font set text and location
				 scoreKeeper.setColor(Color.BLUE);//set score font color to blue
				 scoreKeeper.draw(spriteBatch, "Score: " + score, Gdx.graphics.getWidth()- 80, Gdx.graphics.getHeight()- 20); //draw score in upper righthand corner of the screen
